...
% 	\SBD{The rest of this Step is confusing. Rewrote. What dos it matter how researcheers access the data?  and the sentence was not complete.} 
	...
	$Q$ used $I$ to generate the output~\citep{CheneyProvSurvey}. \eat{Many different notions of provenance have been proposed ~\citep{lineageCui, WhyProvBuneman, howProvenanceGreen}, which have been used in various applications such as annotation propagation and the view update problem~\citep{CheneyProvSurvey}.}
	...
	\eat{
	In this paper, we consider three types of provenance: lineage, why-provenance, and how-provenance. \rtwo{Also, we consider ``causality and responsibility''~\cite{MeliouGMS11}, that enrich the information provided by provenance.}
	}
...
Therefore, in this paper, we expand the ideas in \citep{dosso2020data} by proposing new DSs based on two other forms of data provenance: why-provenance~\citep{WhyProvBuneman} and how-provenance~\citep{howProvenanceGreen}.
\rtwo{We also propose other two DS based on the concepts of responsibility~\cite{MeliouGMS11} and the Shapley value~\cite{LivshitsBKS20,DFKM22}}.
