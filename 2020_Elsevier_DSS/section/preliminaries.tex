...
\scream{Why do we need this last? }
% SOME FORMALISM
...
\scream{Is the reset of this paragraph (in particular the next sentence) necessary or can it be deleted?}
...
\scream{This section is much more detailed and formal that the provenance descriptions....}
\
A formal study of causality was introduced in \cite{Halpern2013Causality,ChocklerH04} and later expanded by \citet{MeliouGMS11} to define the causes of answers and non-answers to queries. 
%Causality is related to the provenance of a query result such as lineage and adds more information to it.
In the following, we define causality and responsibility as in \cite{MeliouGMS11}, but only focus on answers to a query since non-answers are not relevant in our context.
