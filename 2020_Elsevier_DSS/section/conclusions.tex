...
Other, more sophisticated, strategies could also be used to decide how credit is distributed between the authors, beyond the uniform distribution used here, in a way to reflect the work performed by them on the cited data.  \rone{We also plan to explore a DS based on Shapley values~\cite{LivshitsBKS20}, exploiting the practical implementation recently suggested in~\cite{DFKM22}.}
