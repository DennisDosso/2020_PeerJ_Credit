...
To understand the tradeoff between these distribution strategies, we performed three sets of experiments using queries over GtoPdb.  The first set of experiments used real queries extracted from citations to GtoPdb published in the British Journal of Pharmacology.  The second set 
