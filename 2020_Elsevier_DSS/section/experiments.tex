...
By the end of 1K queries, credit differentials between tuples as well as between strategies can be seen.  For example, tuple 4 has the highest value of credit overall, with the highest value coming from the why-provenance DS.   This trend continues to the end of 2k queries.
...
Each target family page in GtoPdb has a list of curators, representing the people who worked on the page and who can be considered as co-authors of the page. This list can be obtained using the last query shown in Figure \ref{figure:family_structure}. 
...
The top 20 authors in terms of citations do not have the high values of credit (Figure \ref{figure:2_radars}.a).  Converseley, the authors with the highest values of credit do not necessarily have a large number of citations (Figure \ref{figure:2_radars}.b).
...
For example, author 536 has the highest value of credit, but is not even in the top 20 authors in terms of citations. This means that they receive much more credit from their relatively few citations than author 475, who receives the largest number of citations.
...
\eat{We note that, although not exactly overlapping, the values of credit assigned to the authors by those DS become quite similar with these higher quantities of polynomials, suggesting a sort of equivalence between the two DSs in this case, at least in the task of rewarding authors} (the linear correlation for the values of Figure \ref{figure:3_radars}.c is more than 0.99 with a p-value of 1.32e-32). This is consistent with what we observed for Figure \ref{figure:comparison_on_synthetic_polynomials_2}.
