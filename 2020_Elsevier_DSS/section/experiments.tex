...
By the end of 1K queries, credit differentials between tuples as well as between strategies can be seen.  For example, tuple 4 has the highest value of credit overall, with the highest value coming from the why-provenance DS. \scream{GMS: to me tuple 4 has the highest credit for the Why-P, whereas tuple 3 has the highest for the How-P.}  This trend continues to the end of 2k queries.
