...
\rone{Consider instead the example where the polynomial is $f_1 c2f_1 c_1 + f_1 c2f_2 c_2$. The first monomial receives $1/2$ of the credit, then $f_1$ receives $1/4$ of credit, and the other two tuples receive $1/8$.}
