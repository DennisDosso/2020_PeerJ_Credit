...
\rone{Therefore, when talking about data credit, there are two main aspects to consider: \emph{credit computation}, the process by which the quantity of credit generated by the citation is computed, and \emph{credit distribution}, the process by which credit is distributed and assigned to the responsible entities that contributed to the generation of the data being cited. In this paper we focus on the latter.}
