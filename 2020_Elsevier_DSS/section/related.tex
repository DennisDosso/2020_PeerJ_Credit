...
\rone{Therefore, when talking about data credit, here we are focusing on two aspects of the topic: \emph{credit computation}, the process in which the quantity of credit generated by the citation is computed, and \emph{credit distribution}, the process by which credit is distributed and assigned to the responsible entities that contributed to the generation of the data being cited. In this paper we focus on the latter.}
